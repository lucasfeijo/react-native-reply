...
exports.useMentionsInput = function (props) {
    ...
    var _a = react_1.useState(function () {
        return (__assign(__assign({}, defaultState), { mentionsMap: utils_1.default.getMentionsWithInputText(props.initialValue).map, inputText: utils_1.default.getMentionsWithInputText(props.initialValue).newValue, formattedText: props.initialValue }));
